...
(function($) {
     ...
     * the renderer will create a Hi Low Close module instead.  In that case,
     * data should be supplied like:
     * 
     * > dat = [['07/06/2009',139.68,135.18,135.4], ['06/29/2009',144.66,139.79,140.02], ...]
     * 
     * To generate a candlestick module instead of an OHLC module,
    ...
    $.jqplot.OHLCRenderer = function(){
        ...
        // prop: candleStick
        // true to render module as candleStick.
        // Must have an open price, cannot be a hlc module.
        ...
        // prop: hlc
        // true if is a hi-low-close module (no open price).
    ...
    $.jqplot.OHLCRenderer.prototype.init = function(options) {
        ...
        // if data points have less than 5 values, force a hlc module.
        if (d[0].length < 5) {
