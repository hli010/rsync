...
(function($) {
     ...
     * Plugin renderer to draw a bubble module.  A Bubble module has data points displayed as
     ...
     * bubbles than colors.
     * 
     * Bubbles are autoscaled by default to fit within the module area while maintaining
    ...
    $.jqplot.BubbleRenderer.prototype.init = function(options, plot) {
        ...
        // Factor which decreases bubble size based on how many bubbles on on the module.
