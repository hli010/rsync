...
(function($) {
     ...
     * Draws a Mekko style module which shows 3 dimensional data on a 2 dimensional graph.
     ...
     * 
     * Data is specified per bar in the module.  You can specify data as an array of y values, or as
    ...
    $.jqplot.MekkoRenderer = function(){
        ...
        // prop: borderColor
        // color of the borders between areas on the module
        this.borderColor = null;
        // prop: showBorders
        // True to draw borders lines between areas on the module.
