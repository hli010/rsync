...
(function($) {
     ...
     * Plugin renderer to draw a meter gauge module.
     * 
    ...
    // There are no traditional axes on a gauge module.  We just need to provide
    ...
    $.jqplot.MeterGaugeAxisRenderer.prototype.init = function(options){
        ...
        // have to go Axis scaling in a way to fit module onto plot area
