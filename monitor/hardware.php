    ...
    $no=0;
        ...
        foreach ($dirarray as $key=>$dd) {
            ...
            if (file_exists($logfile)) {
                ...
                <td align=left> <font size=1> <a href=$logfile> $dd </a>
                </font> </td> 
                <td align=left> <font size=1> $arr[IP] </font> </td>
                <td align=left> <font size=1> <a href=\"$logfile\">$arr[CPU]
                </a> </font> </td> 
                <td align=left><font size=1> $os </font> </td> 
                <td align=left> <font size=1>  $arr[Hardware] </font> </td> 
                <td align=left> <font size=1> $arr[Harddisk] </font> </td> 
                <td align=left> <font size=1> $memory </font> </td> 
                </tr>
                ";
                $no++;
           }
